...
$make->tagVeicTracaoProp(     // ***PREENCHER SOMENTE SE: proprietário não for o emitente do MDFe
    $CPF = '33717133934',     // Cadastro de Pessoa Fisica
    $CNPJ = '',               // Cadasto Nacional de Pessoa Juridica
    $RNTRC = '12041732',      // Registro Nacional de Transportes Rodoviarios de Cargas
    $xNome = 'JACIR ZAMBONI', // Nome
    $IE = '',                 // Inscrição Estadual
    $UF = 'PR',               // Unidade Federativa
    $tpProp = '1'             // Preencher com 0-TAC – Agregado; 1-TAC Independente; ou 2 – Outros.
);
