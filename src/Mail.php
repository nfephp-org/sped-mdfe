 ...
 * Esta classe foi eleborada apenas para o caso de por algum motivo o emitente
 * deseje enviar o MDFe a outros e também para manter a compatibilidade e estrutura similar
 * com os outros modulos.
 *
 * @category  Library
...
class Mail extends BaseMail
{
    ...
    {
        $assunto = $this->montaMessagem($pathFile);
     ...
     * @return string
     */
    protected function renderTemplate($xNome, $data, $nMDF, $serie, $vCarga, $razao)
    {
    ...
    /**
     * getTemplate
     * Se o template estiver vazio cria o basico
     */
    protected function getTemplateFile()
    {
        if (empty($this->template)) {
            $this->template = "<p><b>Prezados,</b></p>"
                ...
                . "<p><i>Manifesto Eletrônico de Documentos Fiscais (MDF-e) é o documento emitido"
                ...
                . "unidade federada do contribuinte.</i></p><p><i>O MDF-e deverá ser emitido por"
                ...
                . "</i></p>A finalidade do MDF-e é agilizar o registro em lote de documentos "
                . "fiscais em trânsito e identificar a unidade de carga utilizada e demais "
                . "características do transporte.</i></p>Autorização de uso do MDF-e implicará "
                . "em registro posterior dos eventos, nos documentos fiscais <p>Para mais "
                . "detalhes, consulte: <a href=\"http://https://mdfe-portal.sefaz.rs.gov.br/\">"
                . "https://mdfe-portal.sefaz.rs.gov.br</a></p><br><p>Atenciosamente,</p>"
                . "<p>{emitente}</p>";
        }
    }
}
